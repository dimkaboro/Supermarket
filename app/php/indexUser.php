...
<script>
    ...
    function handleCheckoutFormSubmit(event) {
        ...
        alert('Order successfully placed!'); // Сообщение о успешном заказе
