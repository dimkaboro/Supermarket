...
<body class="bg-gray-50">
    ...
    <header class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <h1 class="text-2xl font-bold text-green-600">Додати користувача</h1>
        </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-2xl font-bold mb-6 text-gray-700 text-center">Форма додавання користувача</h2>
            <form method="POST" class="space-y-4">
                ...
                <!-- Пол -->
                <div>
                    <label for="gender" class="block text-sm font-medium text-gray-700">Пohlaví:</label>
